...
def chek_win(pole):
	global game_work
	if pole[0]==pole[1]==pole[2]!="-" or  pole[3]==pole[4]==pole[5]!="-" or  pole[6]==pole[7]==pole[8]!="-" or  pole[0]==pole[3]==pole[6]!="-" or  pole[1]==pole[4]==pole[7]!="-" or  pole[2]==pole[5]==pole[8]!="-" or  pole[0]==pole[4]==pole[8]!="-" or  pole[2]==pole[4]==pole[6]!="-":
		output(pole)
		game_work = False
	else:
		output(pole)
